        ...
        <div className='px-5 grid grid-cols-12'>
            <div className="col-span-12">
                ...
                <div className="mt-10">
                    ...
                    { tab === "original" && <CreatorStoriesComponent title="Originals" editUrl="/dashboard/write-original-story" /> }
                    { tab === "with-ai" && <CreatorStoriesComponent title="With AI" editUrl="/dashboard/write-ai-story" /> }
                    { tab === "drafts" && <CreatorStoriesComponent title="Drafts" editUrl="/dashboard/write-original-story" /> }
                </div>
